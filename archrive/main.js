...
// 翻译字幕
const translateSubtitles = async (subtitles, previousTranslation = '', maxTokens) => {
    let attempts = 0;
...
const main = async () => {
    ...
    try {
        ...
        for (let i = 0; i < totalParts; i++) {
            ...
            const translatedPart = await translateSubtitles(part, previousTranslation, maxTokens);
            if (translatedPart) {
